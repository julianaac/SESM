...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="POS" value="POS" class="custom-control-input" name="documentation_certificate_birth" >
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="NPS" value="NPS" class="custom-control-input" name="documentation_certificate_birth">
        <label class="custom-control-label" for="NPS">Não possui</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="SIN" value="SIN" class="custom-control-input" name="documentation_certificate_birth">
...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="PVD" value="PVD"class="custom-control-input" name="documentation_card_vaccination" >
        <label class="custom-control-label" for="PVD">Possui, com vacinação em dia</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="PVI" value="PVI" class="custom-control-input" name="documentation_card_vaccination">
        <label class="custom-control-label" for="PVI">Possui, com vacinação incompleta</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="NPO" value="NPO" class="custom-control-input" name="documentation_card_vaccination">
        <label class="custom-control-label" for="NPO">Não possui</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="SEI" value="SEI" class="custom-control-input" name="documentation_card_vaccination">
...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="PFE" value="PFE" class="custom-control-input" name="documentation_historic_school" >
        <label class="custom-control-label" for="PFE">Possui; estava frequentando a escola</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="PNF" value="PNF" class="custom-control-input" name="documentation_historic_school">
        <label class="custom-control-label" for="PNF">Possui; não estava frequentando a escola</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="NPI" value="NPI" class="custom-control-input" name="documentation_historic_school">
        <label class="custom-control-label" for="NPI">Não possui</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="SIF" value="SIF" class="custom-control-input" name="documentation_historic_school">
        <label class="custom-control-label" for="SIF">Sem informação</label>
    </div>
</fieldset>
<div class="form-check">
    <input class="form-check-input" type="checkbox" value="1" id="documentation_studies_reports" name="documentation_studies_reports">
