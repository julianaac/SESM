...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="iYes"class="custom-control-input" value="1" {{ $edu_sit_previou->age_school == '1' ? 'checked' : '' }}  name="edu_sit_previou_age_school" >
        <label class="custom-control-label" for="iYes">Sim</label>
        <fieldset>
            <label>A criança estava frequentando a escola? </label>
            <div class="custom-control custom-radio">
                <input type="radio" id="iYes2"class="custom-control-input" value="1" {{ $edu_sit_previou->frequent_school == '1' ? 'checked' : '' }}  name="edu_sit_previou_frequent_school" >
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="iNo2" class="custom-control-input" value="0"  {{ $edu_sit_previou->frequent_school == '0' ? 'checked' : '' }}  name="edu_sit_previou_frequent_school">
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="iNo" class="custom-control-input" value="0"  {{ $edu_sit_previou->age_school == '0' ? 'checked' : '' }}  name="edu_sit_previou_age_school">
