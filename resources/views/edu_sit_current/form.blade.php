...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="iYes"class="custom-control-input" value="1" name="edu_sit_current_age_school" >
        ...
        <fieldset>
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="iYes2"class="custom-control-input" value="1" name="edu_sit_current_routine_assignment" >
                <label class="custom-control-label" for="iYes2">Sim</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" id="iNo2" class="custom-control-input" value="0" name="edu_sit_current_routine_assignment">
        ...
        <fieldset>
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="iYes3"class="custom-control-input" value="1" name="edu_sit_current_difficulty_learning" >
                <label class="custom-control-label" for="iYes3">Sim</label>
                <div class="form-group">
                    <label for="edu_sit_current_difficulty_learning_description">quem identificou tais indícios? Quais os encaminhamentos realizados?</label>
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="iNo3" class="custom-control-input" value="0" name="edu_sit_current_difficulty_learning">
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="iNo" class="custom-control-input" value="0" name="edu_sit_current_age_school">
        ...
        <fieldset>
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="iYes4"class="custom-control-input" value="1" name="edu_sit_current_room_activities" >
                <label class="custom-control-label" for="iYes4">Sim</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" id="iNo4" class="custom-control-input" value="0" name="edu_sit_current_room_activities">
        ...
        <fieldset>
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="iYes5"class="custom-control-input" value="1" name="edu_sit_current_development_expected" >
                <label class="custom-control-label" for="iYes5">Sim</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" id="iNo5" class="custom-control-input" value="0" name="edu_sit_current_development_expected">
