...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="ticket_host_hour_input" name="ticket_host_hour_input" value="{{isset($ticket_host->hour_input) ? $ticket_host->hour_input: null}}">
</div>
<div class="form-group">
...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="iNo" class="custom-control-input" value="0"  {{ $ticket_host->referral_judicial == '0' ? 'checked' : '' }}  name="ticket_host_referral_judicial">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ticket_host_time_after" placeholder="Descreva a deficiência" name="ticket_host_time_after" value="{{isset($ticket_host->time_after) ? $ticket_host->time_after: null}}">
        </div>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="iYes"class="custom-control-input" value="1" {{ $ticket_host->referral_judicial == '1' ? 'checked' : '' }}  name="ticket_host_referral_judicial" >
