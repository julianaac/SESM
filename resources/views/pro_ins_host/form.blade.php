{{--{{isset($pro_ins_host->pro_ins_host_name) ? $$pro_ins_host->pro_ins_host_name: null}}--}}


<fieldset>
        <label>A criança está inserida em alguma atividade do serviço de psicologia?</label>
        <div class="custom-control custom-radio">
                <input type="radio" id="iYes"class="custom-control-input" value="1" name="pro_ins_host_service_psychological" >
                <label class="custom-control-label" for="iYes">Sim</label>
        </div>
        <div class="custom-control custom-radio">
            <input type="radio" id="iNo" class="custom-control-input" value="0" name="pro_ins_host_service_psychological">
...
<fieldset>
    ...
    <div class="custom-control custom-radio">
            <input type="radio" id="iYes2"class="custom-control-input" value="1" name="pro_ins_host_service_external" >
            <label class="custom-control-label" for="iYes2">Sim</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="iNo2" class="custom-control-input" value="0" name="pro_ins_host_service_external">
