...
<fieldset>
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="iYes"class="custom-control-input" value="1" {{ $data_health->use_medication == '1' ? 'checked' : '' }}  name="data_health_use_medication" >
        <label class="custom-control-label" for="iYes">Sim</label>
    </div>
    <div class="custom-control custom-radio">
        <input type="radio" id="iNo" class="custom-control-input" value="0"  {{ $data_health->use_medication == '0' ? 'checked' : '' }}  name="data_health_use_medication">
